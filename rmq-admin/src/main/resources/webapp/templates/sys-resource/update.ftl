    ...
    <table>
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <input name="parentName" id="editResourceParentName" type="text" class="easyui-validatebox"
                       readonly="readonly" style="width: 165px;"/>
                <input type="button" value="选择"
                       onClick="selectParentMenu($('#resource-updateform #editResourceParentId'), $('#resource-updateform #editResourceParentName'));"
                       style="width: 50px"/>
                <input type="button" value="清空"
                       onClick="clearParentMenu($('#resource-updateform #editResourceParentId'),$('#resource-updateform #editResourceParentName'));"
                       style="width: 50px"/>
            </td>
        </tr>
    </table>
