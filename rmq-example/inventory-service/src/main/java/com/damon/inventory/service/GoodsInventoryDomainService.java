...
import com.damon.inventory.entity.GoodsInventoryLog;
...
public class GoodsInventoryDomainService implements IGoodsInventoryDomainService {
    ...
    public boolean deductionGoodsInventory(GoodsInventoryDedcutionDTO dedcution) {
        ...
        for (GoodsInventoryDedcutionDTO.PlaceOrderGoods goods : dedcution.getGoods()) {
    ...
    public boolean rollbackGoodsInventory(Long orderId) {
        ...
        List<GoodsInventoryDedcutionDTO.PlaceOrderGoods> goodsList = JSONArray.parseArray(goodsInventoryLog.getPlacOrderGoodsListJson(), GoodsInventoryDedcutionDTO.PlaceOrderGoods.class);
        for (GoodsInventoryDedcutionDTO.PlaceOrderGoods goods : goodsList) {
